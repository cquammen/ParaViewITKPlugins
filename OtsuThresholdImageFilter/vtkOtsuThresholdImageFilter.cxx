...
//----------------------------------------------------------------------------
void vtkOtsuThresholdImageFilter::InitializeITKImporter()
{
...
//----------------------------------------------------------------------------
void vtkOtsuThresholdImageFilter::InitializeITKExporter()
{
  // This call takes the place of the usual SetInput() method.
...
//----------------------------------------------------------------------------
int vtkOtsuThresholdImageFilter::RequestData(vtkInformation *request,
					    ...
					    vtkInformationVector *outputVector)
{
  ...
  this->OtsuFilter->SetInput(this->ITKImporter->GetOutput());
  ...
  this->ITKExporter->SetInput(this->OtsuFilter->GetOutput());
